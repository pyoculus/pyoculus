...
Setup the SPEC fortran module variables.
...
def setup_fortran_module(spec_data, lvol):
    """
    Initialize the variables for the fortran module.
    ...
    try:
        rpol = spec_data.input.physics.rpol
        rtor = spec_data.input.physics.rtor
    except:
        rpol = 1.0
        rtor = 1.0
    ...
    if lvol > 0 and lvol <= spec_data.output.Mvol:
        # setting up the fortran module
        fortran_module.specvariables.rpol = rpol
        fortran_module.specvariables.rtor = rtor
